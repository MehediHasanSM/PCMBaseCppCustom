...
IsSingular <- function(X, threshold_SV) {
    .Call('_PCMBaseCpp_IsSingular', PACKAGE = 'PCMBaseCpp', X, threshold_SV)
}

PairSums <- function(elems) {
    .Call('_PCMBaseCpp_PairSums', PACKAGE = 'PCMBaseCpp', elems)
}

DecomposeH <- function(H, threshold_SV) {
    .Call('_PCMBaseCpp_DecomposeH', PACKAGE = 'PCMBaseCpp', H, threshold_SV)
}

CDFExpDivLambda <- function(Lambda_ij, time, threshold_Lambda_ij) {
    .Call('_PCMBaseCpp_CDFExpDivLambda', PACKAGE = 'PCMBaseCpp', Lambda_ij, time, threshold_Lambda_ij)
}

VOU <- function(H, Sigma, time, threshold_SV, threshold_Lambda_ij) {
