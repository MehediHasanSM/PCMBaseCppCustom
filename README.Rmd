...
[![Travis build status](https://travis-ci.com/venelin/PCMBaseCpp.svg?branch=master)](https://travis-ci.com/venelin/PCMBaseCpp)
...
For further examples, read the [Getting started](https://venelin.github.io/PCMBaseCpp/PCMBaseCpp.html) guide and the  reference available on the package [homepage](https://venelin.github.io/PCMBaseCpp).
